...
export default function Footer() {
  return (
    <footer id="contact" className="bg-secondary text-secondary-foreground pt-20 pb-10 border-t border-white/10">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-slate-400">
                ...
                <span>contact@netizens.team</span>
              </li>
              <li className="flex items-start gap-3 text-slate-400">
                <Twitter className="w-5 h-5 text-primary shrink-0" />
                <span>@teamnetizens</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm mb-4">Subscribe to our newsletter for the latest cybersecurity tips.</p>
